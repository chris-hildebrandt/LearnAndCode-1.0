...
/// Week 6 scaffolding: this class throws until students implement it with EF Core.
/// </summary>
public class TaskRepository : ITaskRepository
{
    ...
    /// TODO Week 6: Return all tasks ordered by priority, then due date.
    ...
    {
        // This is a placeholder. In Week 6, you will write the Entity Framework Core query to get all tasks.
        throw new NotImplementedException("Week 6: Implement repository read operations.");
    }

    /// <summary>
    /// This method will contain the logic to find a single task by its ID in the database.
    /// TODO Week 6: Query for a single task. Include the Project navigation property.
    /// Return <c>null</c> when not found.
    /// </summary>
    public Task<TaskEntity?> GetByIdAsync(int id, CancellationToken cancellationToken = default)
    {
        // This is a placeholder. In Week 6, you will write the EF Core query to find a task by its ID.
        throw new NotImplementedException("Week 6: Implement repository read operations.");
    }

    /// <summary>
    /// This method will contain the logic to add a new task to the database.
    /// TODO Week 6: Persist a new task. Save changes and return the entity with generated key.
    /// </summary>
    public Task<TaskEntity> CreateAsync(TaskEntity entity, CancellationToken cancellationToken = default)
    {
        // This is a placeholder. In Week 6, you will write the EF Core code to add a new entity and save changes.
        throw new NotImplementedException("Week 6: Implement repository create operation.");
    }

    /// <summary>
    /// This method will contain the logic to update an existing task in the database.
    /// TODO Week 6: Update an existing task. Ensure concurrency-safe pattern.
    /// </summary>
    public Task UpdateAsync(TaskEntity entity, CancellationToken cancellationToken = default)
    {
        // This is a placeholder. In Week 6, you will write the EF Core code to update an existing entity.
        throw new NotImplementedException("Week 6: Implement repository update operation.");
    }

    /// <summary>
    /// This method will contain the logic to delete a task from the database.
    /// TODO Week 6: Remove a task. Return without error when entity is already deleted.
    /// </summary>
    public Task DeleteAsync(TaskEntity entity, CancellationToken cancellationToken = default)
    {
        // This is a placeholder. In Week 6, you will write the EF Core code to remove an entity.
        throw new NotImplementedException("Week 6: Implement repository delete operation.");
    }
}